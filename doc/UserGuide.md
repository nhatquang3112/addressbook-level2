...
### Sort all persons in alphabetical order : `sortAlphabet`
Sorts all persons in the address book, in alphabetical order, case-insensitive, then list all persons.<br>
Format: `sortAlphabet`

### Editing a person: `edit`
Edits the specified person's information in the address book<br>
